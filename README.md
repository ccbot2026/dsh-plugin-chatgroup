...
DeepSeek Harness (dsh) 群聊插件：在当前 dsh 会话中创建由 1 个人类用户和多个 AI 成员组成的讨论群（v0.4.0，支持多群）。
...
- [x] V2.6：v0.3.0 发布
- [x] V0.4.0：体验与稳定性（配置一致性 / prompt 调优 / 性能 / RPC 集成测试）（多群 / 消息编辑撤回 / AI 主动发言 / 首轮中断摘要 / 群重命名 / 工具活动提示，51/51 测试通过）。
