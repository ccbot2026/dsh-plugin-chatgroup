...
> 状态：**V2 已完成（v2.0.0 发布，2026-08-16）**；M1–M9 与 V2.1–V2.6 全部落地
> 日期：2026-08-15
...
### 1.1b V2 里程碑（v2.0.0，2026-08-16 完成）
...
| V2.6 | 测试补全（51/51）、文档同步、v2.0.0 发布 | 完成 |
...
- V2.0.0（breaking：持久化 schema v2、RPC payload 增加 groupId，但保持缺省兼容）：
