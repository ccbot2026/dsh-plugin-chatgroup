...
> 状态：**V2 已完成（v0.3.0）**，**0.4.0（体验与稳定性）已完成（2026-08-16）**；M1–M9 与 V2.1–V2.6、0.4.0 五方向全部落地
> 日期：2026-08-15
> 范围：下一开发周期 V3 续（体验与稳定性，具体见 0.4.0 已完成项与 backlog）
...
| maxGroups 默认值 | 定稿（v0.4.0）：**1** | 与 v0.2 行为一致；面板可调大（0.4.0-① 已让面板设置对 create 生效） |

---

## 7. 待群内确认（本轮讨论后需要拍板）

1. ~~maxGroups 默认值~~ → **已定稿为 1**（v0.4.0-②）
